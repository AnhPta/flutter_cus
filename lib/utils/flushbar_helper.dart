...
class FlushbarHelper {
  ...
  static Flushbar createSuccess({@required String message,
    String title,
  ...
  static Flushbar createWarning({@required String message,
    String title,
    Duration duration = const Duration(seconds: 3)}) {
    return Flushbar(
      flushbarPosition: FlushbarPosition.TOP,
  ...
  static Flushbar createAction({@required String message,
  ...
  static Flushbar createLoading({@required String message,
    String title,
